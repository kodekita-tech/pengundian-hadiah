                                    ...
                                    <div class="info-item">
                                        ...
                                        <div class="info-content">
                                            ...
                                            <span class="info-value organizer-name"
                                                title="{{ $event->opd->nama_penyelenggara }}">{{ $event->opd->nama_penyelenggara }}</span>
                                        </div>
                                    </div>
                                @endif
                            </div>
...
@push('styles')
    ...
    <style>
        ...
        /* Organizer name - handle long names */
        .info-value.organizer-name {
            display: -webkit-box;
            -webkit-line-clamp: 2;
        ...
        /* Inline row for participant data (Nama, HP, Asal) */
        .data-row-inline {
            display: grid;
        ...
        .data-item-inline .data-label {
            margin-bottom: 0.25rem;
            justify-content: center;
        }

        .data-item-inline .data-value {
            font-size: 1rem;
        ...
        /* Print Styles - Fit in 1 page, similar to HTML */
        @page {
            size: A4;
            margin: 10mm;
        }
        ...
        @media (max-width: 768px) {
            ...
            /* Inline row responsive - stack on small screens */
            .data-row-inline {
