...
<head>
	...
	<meta property="og:title" content="Login | GXON HR Management Admin Dashboard Template + RTL">
	...
	<meta name="twitter:title" content="Login | GXON HR Management Admin Dashboard Template + RTL">
	<meta name="twitter:description"
		content="GXON is a professional and modern HR Management Admin Dashboard Template built with Bootstrap. It includes light and dark modes, and is ideal for managing employees, attendance, payroll, recruitment, and more — perfect for HR software and admin panels.">
	<!-- end::GXON Meta Twitter -->

	<!-- begin::GXON Website Page Title -->
	<title>Login | GXON HR Management Admin Dashboard Template + RTL</title>
...
<body>
	...
	<script>
		// Ensure light theme is maintained after appSettings.js runs
		setAppSettings({ appTheme: 'light' });
	</script>
	<script src="{{ asset('assets') }}/js/main.js"></script>
	<script>
		// Final check to ensure light theme is maintained
