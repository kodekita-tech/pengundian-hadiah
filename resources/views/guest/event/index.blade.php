...
<div class="event-list-wrapper"
    style="min-height: 100vh; background: linear-gradient(135deg, #98FB98 0%, #00BFFF 100%); background-attachment: fixed; padding: 2rem 0;">
    <div class="container py-5">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Join us for an exciting tech conference featuring the latest innovations in
                            technology, networking opportunities, and keynote speakers from industry leaders.</p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Learn the latest strategies and techniques in digital marketing. This
                            workshop covers SEO, social media marketing, content strategy, and more.</p>
                        <div class="d-flex justify-content-between align-items-center mt-3">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Connect with professionals from various industries. A great opportunity to
                            expand your network and share experiences with like-minded individuals.</p>
                        <div class="d-flex justify-content-between align-items-center mt-3">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Our annual company gathering was a huge success! Thank you to everyone who
                            attended and made it a memorable event.</p>
                        <div class="d-flex justify-content-between align-items-center mt-3">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 shadow-sm">
                    <div class="card-img-top position-relative"
                        style="height: 200px; background: linear-gradient(135deg, #30cfd0 0%, #330867 100%);">
                        <div class="position-absolute top-0 end-0 m-3">
                            <span class="badge bg-light text-dark">Upcoming</span>
                        </div>
                        <div class="d-flex align-items-center justify-content-center h-100">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Be the first to see our latest product innovations. Join us for an
                            exclusive launch event with live demonstrations and special offers.</p>
                        <div class="d-flex justify-content-between align-items-center mt-3">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 shadow-sm">
                    <div class="card-img-top position-relative"
                        style="height: 200px; background: linear-gradient(135deg, #a8edea 0%, #fed6e3 100%);">
                        <div class="position-absolute top-0 end-0 m-3">
                            <span class="badge bg-light text-dark">Upcoming</span>
                        </div>
                        <div class="d-flex align-items-center justify-content-center h-100">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Join us for a meaningful charity event to support local communities. Your
                            participation makes a difference in people's lives.</p>
                        <div class="d-flex justify-content-between align-items-center mt-3">
            ...
            <div class="col-12">
                <div class="card bg-primary text-white">
                    <div class="card-body text-center p-5">
                        ...
                        <p class="card-text mb-4">Subscribe to our newsletter to get notified about upcoming events and
